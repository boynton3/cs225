...
```
==36707== Memcheck, a memory error detector
==36707== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==36707== Using Valgrind-3.14.0 and LibVEX; rerun with -h for copyright info
==36707== Command: ./test -r xml "List::insertFront\ size"
==36707== 
==36707== Conditional jump or move depends on uninitialised value(s)
==36707==    at 0x42831C: List<int>::insertFront(int const&) (List.hpp:55)
==36707==    by 0x421FF7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==36707==    by 0x461F62: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==36707==    by 0x4526B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==36707==    by 0x4525EC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==36707==    by 0x44EB46: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==36707==    by 0x44D11E: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==36707==    by 0x4564B6: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==36707==    by 0x455152: Catch::Session::runInternal() (catch.hpp:10149)
==36707==    by 0x454E1A: Catch::Session::run() (catch.hpp:10106)
==36707==    by 0x454D99: Catch::Session::run(int, char**) (catch.hpp:10074)
==36707==    by 0x481E11: main (catch.hpp:13613)
==36707== 
==36707== Conditional jump or move depends on uninitialised value(s)
==36707==    at 0x428356: List<int>::insertFront(int const&) (List.hpp:58)
==36707==    by 0x421FF7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==36707==    by 0x461F62: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==36707==    by 0x4526B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==36707==    by 0x4525EC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==36707== 
==36707== Conditional jump or move depends on uninitialised value(s)
==36707==    at 0x452760: Catch::RunContext::handleExpr(Catch::AssertionInfo const&, Catch::ITransientExpression const&, Catch::AssertionReaction&) (catch.hpp:9683)
==36707==    by 0x43063B: Catch::AssertionHandler::handleExpr(Catch::ITransientExpression const&) (catch.hpp:5467)
==36707==    by 0x422154: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:25)
==36707==    by 0x461F62: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==36707==    by 0x4526B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==36707==    by 0x4525EC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==36707==    by 0x44EB46: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
...
==36707== 
==36707== HEAP SUMMARY:
==36707==     in use at exit: 240 bytes in 10 blocks
==36707==   total heap usage: 2,132 allocs, 2,122 frees, 252,400 bytes allocated
==36707== 
==36707== 240 bytes in 10 blocks are definitely lost in loss record 1 of 1
==36707==    at 0x4C29EA3: malloc (vg_replace_malloc.c:309)
==36707==    by 0x4E53F8B: operator new(unsigned long) (stdlib_new_delete.cpp:33)
==36707==    by 0x4282D3: List<int>::insertFront(int const&) (List.hpp:51)
==36707==    by 0x421FF7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==36707==    by 0x461F62: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==36707==    by 0x4526B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==36707==    by 0x4525EC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==36707== 
==36707== LEAK SUMMARY:
==36707==    definitely lost: 240 bytes in 10 blocks
==36707==    indirectly lost: 0 bytes in 0 blocks
==36707==      possibly lost: 0 bytes in 0 blocks
==36707==    still reachable: 0 bytes in 0 blocks
==36707==         suppressed: 0 bytes in 0 blocks
==36707== 
==36707== For counts of detected and suppressed errors, rerun with: -v
==36707== Use --track-origins=yes to see where uninitialised values come from
==36707== ERROR SUMMARY: 13 errors from 4 contexts (suppressed: 0 from 0)
...
```
==36737== Memcheck, a memory error detector
==36737== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==36737== Using Valgrind-3.14.0 and LibVEX; rerun with -h for copyright info
==36737== Command: ./test -r xml "List::_destroy\ empty\ list"
==36737== 
==36737== 
==36737== HEAP SUMMARY:
==36737==     in use at exit: 0 bytes in 0 blocks
==36737==   total heap usage: 2,140 allocs, 2,140 frees, 253,232 bytes allocated
==36737== 
==36737== All heap blocks were freed -- no leaks are possible
==36737== 
==36737== For counts of detected and suppressed errors, rerun with: -v
==36737== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 0 from 0)
...
This report was generated for **boynton3** using **2005afa8eb6c9f0083bd24279955eef129c38532** (from **February 25th 2020, 11:59:59 pm**)
