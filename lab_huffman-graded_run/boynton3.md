...
```
==47297== Memcheck, a memory error detector
==47297== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==47297== Using Valgrind-3.14.0 and LibVEX; rerun with -h for copyright info
==47297== Command: ./test -r xml "test_the_works"
==47297== 
==47297== 
==47297== HEAP SUMMARY:
==47297==     in use at exit: 0 bytes in 0 blocks
==47297==   total heap usage: 1,903 allocs, 1,903 frees, 305,504 bytes allocated
==47297== 
==47297== All heap blocks were freed -- no leaks are possible
==47297== 
==47297== For counts of detected and suppressed errors, rerun with: -v
==47297== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 0 from 0)
