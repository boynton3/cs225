...
==15766== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==15766== Using Valgrind-3.14.0 and LibVEX; rerun with -h for copyright info
==15766== Command: ./test -r xml "List::insertFront\ size"
==15766== 
==15766== Conditional jump or move depends on uninitialised value(s)
==15766==    at 0x42831C: List<int>::insertFront(int const&) (List.hpp:55)
==15766==    by 0x421FF7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==15766==    by 0x461F62: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==15766==    by 0x4526B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==15766==    by 0x4525EC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==15766==    by 0x44EB46: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==15766==    by 0x44D11E: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==15766==    by 0x4564B6: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==15766==    by 0x455152: Catch::Session::runInternal() (catch.hpp:10149)
==15766==    by 0x454E1A: Catch::Session::run() (catch.hpp:10106)
==15766==    by 0x454D99: Catch::Session::run(int, char**) (catch.hpp:10074)
==15766==    by 0x481E11: main (catch.hpp:13613)
==15766== 
==15766== Conditional jump or move depends on uninitialised value(s)
==15766==    at 0x428356: List<int>::insertFront(int const&) (List.hpp:58)
==15766==    by 0x421FF7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==15766==    by 0x461F62: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==15766==    by 0x4526B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==15766==    by 0x4525EC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==15766== 
==15766== Conditional jump or move depends on uninitialised value(s)
==15766==    at 0x452760: Catch::RunContext::handleExpr(Catch::AssertionInfo const&, Catch::ITransientExpression const&, Catch::AssertionReaction&) (catch.hpp:9683)
==15766==    by 0x43063B: Catch::AssertionHandler::handleExpr(Catch::ITransientExpression const&) (catch.hpp:5467)
==15766==    by 0x422154: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:25)
==15766==    by 0x461F62: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==15766==    by 0x4526B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==15766==    by 0x4525EC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==15766==    by 0x44EB46: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
...
==15766== 
==15766== HEAP SUMMARY:
==15766==     in use at exit: 240 bytes in 10 blocks
==15766==   total heap usage: 2,132 allocs, 2,122 frees, 252,400 bytes allocated
==15766== 
==15766== 240 bytes in 10 blocks are definitely lost in loss record 1 of 1
==15766==    at 0x4C29EA3: malloc (vg_replace_malloc.c:309)
==15766==    by 0x4E53F8B: operator new(unsigned long) (stdlib_new_delete.cpp:33)
==15766==    by 0x4282D3: List<int>::insertFront(int const&) (List.hpp:51)
==15766==    by 0x421FF7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==15766==    by 0x461F62: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==15766==    by 0x4526B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==15766==    by 0x4525EC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==15766== 
==15766== LEAK SUMMARY:
==15766==    definitely lost: 240 bytes in 10 blocks
==15766==    indirectly lost: 0 bytes in 0 blocks
==15766==      possibly lost: 0 bytes in 0 blocks
==15766==    still reachable: 0 bytes in 0 blocks
==15766==         suppressed: 0 bytes in 0 blocks
==15766== 
==15766== For counts of detected and suppressed errors, rerun with: -v
==15766== Use --track-origins=yes to see where uninitialised values come from
==15766== ERROR SUMMARY: 13 errors from 4 contexts (suppressed: 0 from 0)
...
```
==15784== Memcheck, a memory error detector
==15784== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==15784== Using Valgrind-3.14.0 and LibVEX; rerun with -h for copyright info
==15784== Command: ./test -r xml "List::_destroy\ empty\ list"
==15784== 
==15784== 
==15784== HEAP SUMMARY:
==15784==     in use at exit: 0 bytes in 0 blocks
==15784==   total heap usage: 2,140 allocs, 2,140 frees, 253,232 bytes allocated
==15784== 
==15784== All heap blocks were freed -- no leaks are possible
==15784== 
==15784== For counts of detected and suppressed errors, rerun with: -v
==15784== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 0 from 0)
